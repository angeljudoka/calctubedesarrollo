...
/**
 * Description of CanaletaTipoController
 *
...
use BackendBundle\Entity\CanaletaTipo;

class CanaletaTipoController extends Controller {
        ...
        if ($authCheck == true) {
            ...
            if ($json != null) {
                ...
                if ($usuario_id != null) {
                    ...
                    $nombreBase = $em->getRepository("BackendBundle:CanaletaTipo")->findOneBy(
                            array(
                                "nombre" => $nombre
                    ));

                    $canaleta = new CanaletaTipo();
        ...
        if ($authCheck == true) {
            ...
            if ($json != null) {
                ...
                if ($usuario_id != null && $canaleta_id != null) {
                    ...
                    $canaleta = $em->getRepository("BackendBundle:CanaletaTipo")->findOneBy(
                            array(
                                "id" => $canaleta_id
                    ));
    ...
    public function paginadoAction(Request $request) {
        ...
        $dql = "SELECT a FROM BackendBundle:CanaletaTipo a ORDER BY a.nombre ASC";
    ...
    public function detailAction(Request $request, $id = null) {
        ...
        $canaleta = $em->getRepository("BackendBundle:CanaletaTipo")->findOneBy(array(
            "id" => $id
        ));
